...
VALUES (1, 'Công ty Thực phẩm Tươi Sống FreshFood', '0912000111', 'freshfood.hn@gmail.com', 'Số 15, Nguyễn Văn Linh, Hà Nội'),
       ...
       (19, 'Xưởng sản xuất Đồ hộp ViệtCan', '0900333222', 'vietcan.canned@gmail.com', 'Lô B1, KCN Long Thành, Đồng Nai'),
       (20, 'Nhà cung cấp Đồ uống tinh khiết AquaPure', '0922113344', 'aquapure.water@email.com', '15 Cách Mạng Tháng 8, Hà Nội'),
       (21, 'Siêu thị Hàng nhập khẩu GlobalMart', '0988111222', 'globalmart.shop@gmail.com', '50 Trần Hưng Đạo, TP.HCM'),
       ...
       (25, 'Xưởng sản xuất Trà thảo mộc HerbalTea', '0988222333', 'herbaltea.natural@gmail.com', '88 Phan Đình Phùng, Đà Nẵng'),
       (26, 'Công ty Sản xuất Đường mía SweetSugar', '0911555777', 'sweetsugar.refined@email.com', 'Số 6, Quang Trung, Hà Nội'),
       (27, 'Cửa hàng Đồ khô và Hạt dinh dưỡng NutriStore', '0966555777', 'nutristore.vn@gmail.com', '12 Nguyễn Đình Chiểu, Hà Nội'),
       (28, 'Công ty Bột mì và Ngũ cốc FlourMill', '0933666777', 'flourmill.foods@email.com', 'KCN Biên Hòa, Đồng Nai'),
       (29, 'Nhà máy Sản xuất Gia vị SFlavor', '0955111222', 'sflavor.spices@outlook.com', 'Lô 8, KCN Bình Dương, Bình Dương'),
       (30, 'Công ty Nông sản Xanh FreshAgro', '0999888777', 'freshagro.vn@gmail.com', 'Nông trại Đông Anh, Hà Nội'),
       (31, 'Nhà cung cấp Thực phẩm Đông lạnh ColdPack', '0933222111', 'coldpack.frozen@email.com', 'KCN Tân Thuận, TP.HCM'),
       ...
       (36, 'Công ty Thịt nguội và Xúc xích SausageLand', '0933666888', 'sausageland.food@email.com', 'KCN Hóc Môn, TP.HCM'),
       (37, 'Xưởng sản xuất Đồ ăn nhanh QuickBites', '0955777888', 'quickbites.fastfood@gmail.com', 'Lô D3, KCN Trà Nóc, Cần Thơ'),
       (38, 'Công ty Đồ uống từ Lúa mạch BarleyDrink', '0977444555', 'barleydrink.brewery@outlook.com', 'KCN Tân An, Long An'),
       (39, 'Nhà cung cấp Dầu thực vật PureOil', '0966333555', 'pureoil.vn@gmail.com', 'Cụm CN Đức Hòa, Long An'),
       (40, 'Cửa hàng Gạo và Nông sản Việt RiceHouse', '0905222333', 'ricehouse.agro@email.com', 'Số 20, Hùng Vương, Hà Nội');
